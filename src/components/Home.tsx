          ...
          <div className="w-full flex flex-col px-4 lg:w-5/12">
            <div>
              <p className="max-w-[520px] pt-5 text-base text-justify text-white">
                Our online platform offers seamless image storage, advanced labeling, and image-to-text processing.
                 Easily upload and manage images in a secure cloud, annotate with precision for data analysis,
                and extract text accurately. Unlock the power of your visual data effortlessly.
              </p>
            </div>
            <div>
              <FileUpload />
